...
# python bandit.py --instance ../instances/instances-task1/i-1.txt --algorithm epsilon-greedy-t1 --randomSeed 41 --epsilon 0.02 --scale 2 --threshold 0 --horizon 102400
# ../instances/instances-task1/i-1.txt, epsilon-greedy-t1, 15, 0.02, 2, 0, 102400, 41092.0, 0
